...
ImageView::ImageView(const class Device& device, const VkImage image, const VkFormat format, const VkImageAspectFlags aspectFlags, bool isManaged) :
	device_(device),
	image_(image),
	format_(format),
...
ImageView::~ImageView()
{
	if (imageView_ != nullptr && !isManaged_)
	{
